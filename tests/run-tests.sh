...
# --- 両 plugin.json のバージョンが 0.18.1 で一致している（#208 #209 でパッチ更新） ---
...
assert_eq ".claude-plugin/plugin.json のバージョンが0.18.1である" "0.18.1" "$DOC55_CLAUDE_VERSION"
assert_eq ".codex-plugin/plugin.json のバージョンが0.18.1である" "0.18.1" "$DOC55_CODEX_VERSION"
